...
class TestCore(TestCase):
    def setUp(self):
        self.data = read_import_profile("tests/artifacts/accelerate_example.log")
    ...
    def test_calculate_total_time(self):
        ...
        self.assertAlmostEqual(data_copy["children"][0]["total_time"], 1.13, 2)
    ...
    def test_threshold_filtering_pct(self):
        ...
        self.assertEqual(len(important_paths), 10)
